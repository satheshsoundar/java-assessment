...
public class CartController {
    ...
    @DeleteMapping("/api/carts/{code}/entries")
    public Optional<Entry> deleteItem(@PathVariable String code, @RequestBody EntryDTO entryDTO)
            throws CartNotFoundException, EntryNotFoundException {
        getAndPrepareCart(code, entryDTO);
        return cartService.deleteItemInCart(entryDTO);
    }

    @PutMapping("/api/carts/checkout")
    public Cart checkoutCart(@RequestBody Cart cart)
